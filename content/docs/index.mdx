...
<Cards>
  <Card title="Core Concepts" href="/docs/concepts" description="Learn about vaults, sources, routes, and progressive disclosure." />
  <Card title="Command Reference" href="/docs/commands" description="Full reference for every apix command." />
  <Card title="Configuration" href="/docs/configuration" description="Customize apix behavior, sources, and environment." />
</Cards>
